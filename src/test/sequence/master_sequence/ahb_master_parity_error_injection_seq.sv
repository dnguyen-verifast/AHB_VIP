...
class ahb_master_parity_error_injection_seq extends ahb_master_base_seq;
    ...
    extern function new(string name = "ahb_master_parity_error_injection_seq",uvm_component parent=null);
    extern task body();
endclass : ahb_master_parity_error_injection_seq
function ahb_master_parity_error_injection_seq::new(string name = "ahb_master_parity_error_injection_seq",uvm_component parent=null);
