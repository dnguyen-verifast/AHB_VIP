...
class ahb_master_1kb_boundary_violation_seq extends ahb_master_base_seq;
    ...
    extern function new(string name = "ahb_master_1kb_boundary_violation_seq",uvm_component parent=null);
    extern task body();
endclass : ahb_master_1kb_boundary_violation_seq
function ahb_master_1kb_boundary_violation_seq::new(string name = "ahb_master_1kb_boundary_violation_seq",uvm_component parent=null);
