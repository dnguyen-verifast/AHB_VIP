...
class ahb_master_fixed_incr_burst_seq extends ahb_master_base_seq;
    ...
    extern function new(string name = "ahb_master_fixed_incr_burst_seq");
    extern task body();
endclass : ahb_master_fixed_incr_burst_seq
function ahb_master_fixed_incr_burst_seq::new(string name = "ahb_master_fixed_incr_burst_seq");
    super.new(name);
endfunction : new
