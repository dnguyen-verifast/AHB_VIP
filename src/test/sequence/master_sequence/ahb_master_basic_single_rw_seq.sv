...
class ahb_master_basic_single_rw_seq extends ahb_master_base_seq;
    ...
    extern function new(string name = "ahb_master_basic_single_rw_seq",uvm_component parent=null);
    extern task body();
endclass : ahb_master_basic_single_rw_seq
function ahb_master_basic_single_rw_seq::new(string name = "ahb_master_basic_single_rw_seq",uvm_component parent=null);
