...
class ahb_slave_idle_transfer_seq extends ahb_slave_base_seq;
    ...
    extern function new(string name = "ahb_slave_idle_transfer_seq",uvm_component parent=null);
    extern task body();
endclass : ahb_slave_idle_transfer_seq
function ahb_slave_idle_transfer_seq::new(string name = "ahb_slave_idle_transfer_seq",uvm_component parent=null);
