...
class ahb_slave_exclusive_access_seq extends ahb_slave_base_seq;
    ...
    extern function new(string name = "ahb_slave_exclusive_access_seq",uvm_component parent=null);
    extern task body();
endclass : ahb_slave_exclusive_access_seq
function ahb_slave_exclusive_access_seq::new(string name = "ahb_slave_exclusive_access_seq",uvm_component parent=null);
