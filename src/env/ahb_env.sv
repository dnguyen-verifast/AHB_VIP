...
function void ahb_env::connect_phase(uvm_phase phase);
    ...
    ahb_slave_agent_h.ahb_slave_monitor_h.ahb_slave_data_analysis_port.connect(ahb_scoreboard.ahb_slave_data_phase_analysis_fifo.analysis_export);
    ahb_slave_agent_h.ahb_slave_monitor_h.ahb_slave_addr_analysis_port.connect(ahb_scoreboard.ahb_slave_addr_phase_analysis_fifo.analysis_export);

    ahb_master_agent_h.ahb_master_monitor_h.ahb_master_data_analysis_port.connect(ahb_scoreboard.ahb_master_data_phase_analysis_fifo.analysis_export);
    ahb_master_agent_h.ahb_master_monitor_h.ahb_master_addr_analysis_port.connect(ahb_scoreboard.ahb_master_addr_phase_analysis_fifo.analysis_export);
